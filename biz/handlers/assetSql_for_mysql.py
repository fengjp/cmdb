...
class SqlListHandler(BaseHandler):
    def post(self, *args, **kwargs):
        ...
        storage = data.get('storage', False)  #查询存储过程
        storage2 = data.get('storage2', False)  # 重新生成存储过程
        dictvalue = str(data.get('dictvalue', False))  #查询存储过程入参
        dictvalue2 = str(data.get('dictvalue2', False))  # 重新生成存储过程入参
        state = data.get('state', False)
        mode = data.get('mode', False)
        flag = data.get('flag', False)
        authorized = str(data.get('authorized', False))
        fieldname = str(data.get('fieldname', False)) #表名
        create_time = data.get('create_time', False)  #表字段列表
        fieldlist = str([{"name": "bianhao", "zh_name": "编号"},
                         {"name": "number", "zh_name": "chepaihao"},
                         {"name": "name", "zh_name": "姓名"},
                         {"name": "sex", "zh_name": "性别"},
                         {"name": "iphone", "zh_name": "手机号"},
                         {"name": "chepinpai", "zh_name": "车品牌"},
                         {"name": "type", "zh_name": "车类型"},
                         {"name": "zhuangzailiang", "zh_name": "车装载量"}
                         ])
    ...
    def put(self, *args, **kwargs):
        ...
        flag = data.get('flag', False)
        authorized = str(data.get('authorized', False))
        fieldname = str(data.get('fieldname', False))
        create_time = data.get('create_time', False)
        fieldlist = str([
                         {"name": "bianhao", "zh_name": "地區编号"},
                         {"name": "number", "zh_name": "车牌号"},
                         {"name": "username", "zh_name": "姓名"},
                         {"name": "sex", "zh_name": "性别"},
                         {"name": "iphone", "zh_name": "文字"},
                         {"name": "chepinpai", "zh_name": "车品牌"},
                         {"name": "type", "zh_name": "车类型"},
                         {"name": "zhuangzailiang", "zh_name": "车装载量"}
                         ])
...
class getimplementlist(BaseHandler):
    def get(self, *args, **kwargs):
        data_list = []
        data_list2 = []
        parameter = self.get_argument('parameter', strip=True)
        targetKeys = self.get_argument('targetKeys', strip=True)
        ...
        if len(data_list) > 0:
            ...
            data_list3 = [{"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          ...
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 18, "number1": 5, "number2": 88, "number3": 10},
                          {"number0": 1, "number1": 35, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 38, "number3": 10},
                          {"number0": 1, "number1": 35, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 31, "number1": 35, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 38, "number3": 10},
                          {"number0": 1, "number1": 55, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 55, "number2": 8, "number3": 10},
                          {"number0": 21, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 35, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 1, "number1": 5, "number2": 8, "number3": 10},
                          {"number0": 15, "number1": 5, "number2": 8, "number3": 10},
                          ]
            ins_log.read_log('info', "800000000000000000000000000000000000")
        ...
        for j in temp_list2:
            for d in data_list2:
                if str(j["name"]) == str(d["obj"]):
                    j["date"].append(
                        {"k": d["id"], "v": d["name"], "t": d["flag"], "s": d["storage"],"st": d["storage2"], "d": d["fieldlist"],"f": d["fieldname"],"c": d["dictvalue"]})

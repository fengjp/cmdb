...
class ServerHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        ...
        with DBContext('w', None, True) as session:
            new_server = Server(hostname=hostname, ip=ip, private_ip=private_ip, public_ip=public_ip, port=int(port),
                                idc=idc, admin_user=admin_user, region=region, state=state, detail=detail)
